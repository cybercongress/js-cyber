...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.recoveryPeriod !== undefined && (obj.recoveryPeriod = (message.recoveryPeriod || Long.UZERO).toString());
...
export const NeuronBandwidth = {
  ...
  toJSON(message: NeuronBandwidth): unknown {
    ...
    message.remainedValue !== undefined && (obj.remainedValue = (message.remainedValue || Long.UZERO).toString());
